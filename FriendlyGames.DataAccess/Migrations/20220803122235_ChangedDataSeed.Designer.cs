...
namespace FriendlyGames.DataAccess.Migrations
{
    ...
    [Migration("20220803122235_ChangedDataSeed")]
    partial class ChangedDataSeed
    {
            ...
            modelBuilder.Entity("FriendlyGames.Domain.Models.Registration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDateTime = new DateTime(2022, 8, 3, 14, 22, 34, 448, DateTimeKind.Local).AddTicks(9729)
                        },
                        new
                        {
                            EventId = 1,
                            UserId = 2,
                            RegistrationCategoryId = 1,
                            RegistrationDateTime = new DateTime(2022, 8, 3, 14, 22, 34, 448, DateTimeKind.Local).AddTicks(9780)
                        },
                        new
                        {
                            EventId = 2,
                            ...
                            RegistrationDateTime = new DateTime(2022, 8, 3, 14, 22, 34, 448, DateTimeKind.Local).AddTicks(9792)
                        },
                        new
                        {
                            EventId = 2,
                            ...
                            RegistrationDateTime = new DateTime(2022, 8, 3, 14, 22, 34, 448, DateTimeKind.Local).AddTicks(9805)
                        });
                });
