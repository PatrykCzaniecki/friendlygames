...
public class FriendlyGamesDbContext : IdentityDbContext<ApiUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //modelBuilder.Entity<ApiUser>()
        //    .HasData(new ApiUser {Id = 2, FirstName = "Adam", LastName = "Smith"});
        //modelBuilder.Entity<ApiUser>()
        //    .HasData(new ApiUser {Id = 3, FirstName = "Franek", LastName = "Stopka"});
        //modelBuilder.Entity<ApiUser>()
        //    .HasData(new ApiUser {Id = 4, FirstName = "Asia", LastName = "Szul"});
        //modelBuilder.Entity<ApiUser>()
        //    .HasData(new ApiUser {Id = 5, FirstName = "Tomek", LastName = "Broda"});
        //modelBuilder.Entity<ApiUser>()
        //    .HasData(new ApiUser {Id = 6, FirstName = "Grzegorz", LastName = "Wisła"});
