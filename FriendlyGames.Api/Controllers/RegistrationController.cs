    ...
    public class RegistrationController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateRegistration([FromBody] RegistrationCreateUpdateDto registrationCreateDto)
        {
            ...
            try
            {
                ...
                return
                    CreatedAtRoute("GetRegistration", new {eventId = newRegistration.EventId, userId = newRegistration.UserId}, newRegistration);
            }
            catch (Exception exception)
            {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Update([FromBody] RegistrationCreateUpdateDto registrationUpdateDto, int eventId, int userId)
        {
